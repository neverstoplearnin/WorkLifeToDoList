...
public class BookAdapter extends RecyclerView.Adapter<BookAdapter.BookViewHolder> {
    ...
    public class BookViewHolder extends RecyclerView.ViewHolder {
        // below is the line to initialize
    ...
    public void onBindViewHolder(@NonNull BookViewHolder holder, int position) {
        ...
        // below is the line to set the image from URL in our image view.
        Picasso.get().load(bookInfo.getThumbnail()).into(holder.bookIV);

        // below is the line to add on click listener for our item of recycler view.
